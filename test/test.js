  ...
  describe('#extract', function() {
    ...
    before(function (done) {
      jsdom.env(
        ...
        function (err, window) {
          result = extract_test.extract(window,metadata);
          done();
        }
      );
    });
